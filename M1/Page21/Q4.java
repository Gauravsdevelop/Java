...
// Time Complexity: O(n) — Computing prefix products, suffix products, and results each require a single pass through the array.
// Space Complexity: O(n) — The additional arrays (prefixProduct, suffixProduct, and result) each require linear space.
