...
// Time Complexity: O(N^2) because of the two nested loops iterating over each pair of elements in reverse.

// Space Complexity: O(1) since no additional space is used aside from the input array.
