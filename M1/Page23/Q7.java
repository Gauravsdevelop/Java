...
// Time Complexity: O(N^2) due to the two nested loops iterating over the array to check all pairs.

// Space Complexity: O(1) because no additional data structures are used beyond the input array.
