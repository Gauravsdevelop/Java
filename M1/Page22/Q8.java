...
// Time Complexity: O(n) where n is the size of the array, since each element is processed once.
// Space Complexity: O(1) as the array is modified in place without using additional space, except for the input array.
