...
// Time Complexity: O(n) where n is the size of the array, as you iterate through the array twice (once for reading input and once for updating).

// Space Complexity: O(1) since the array is updated in place without using extra space.
