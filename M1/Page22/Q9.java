...
// Time Complexity: O(N), where N is the size of the array, because you are iterating through each element of the array once.
// Space Complexity: O(1) if you don't count the input array itself, as the updates are done in place. If you count the input array, it's O(N) due to the storage of the array.
