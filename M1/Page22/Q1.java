...
// Time Complexity: O(n) where n is the size of the array, since the array is iterated over once.
// Space Complexity: O(1) because the transformation is done in place with no additional space used except for the input array.
