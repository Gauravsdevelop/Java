...
// Time Complexity: O(n) where n is the size of the arrays, as you are iterating through the numbers and indexes arrays once.
// Space Complexity: O(n) due to the creation of the target array of size n.
