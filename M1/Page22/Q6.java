...
// Time Complexity: O(n) because the program processes elements up to left and from right to the end of the array. In the worst case, you still go through the array once.
// Space Complexity: O(1) as the updates are made in place without using any extra space aside from the input array.
